...
| **Offline & PWA** | **Serwist (Service Worker) + IndexedDB** | PWA manifest, offline queue tự động đồng bộ khi có mạng lại, chạy mượt trong trại mất sóng. |
...
| **Báo Cáo & Xuất Liệu** | **ExcelJS + Date-fns** | Xuất Excel chuẩn kế toán (XNT, Thẻ kho, Chi phí dãy trại, Tiêu hao nhiên liệu xe). |
...
14. **Trung Tâm Báo Cáo & Phân Tích (Reports Hub & Excel Export):** Báo cáo tổng hợp, Sổ cái kho (XNT), Thẻ kho chi tiết (Stock Card), Phân tích chi phí từng dãy trại (Zone Cost Drilldown), Báo cáo tiêu hao đội xe, Báo cáo đối tác (NCC/Khách hàng). Xuất Excel chuẩn kế toán.
...
3. **Kế toán (`accountant`):** Quản lý giá mua/bán, duyệt phiếu nhập kho, theo dõi công nợ NCC/Khách hàng, kiểm soát chi phí dãy trại, xuất báo cáo tài chính.
...
6. **Người yêu cầu (`requester`):** Công nhân/Trưởng trại lập phiếu xin cấp vật tư, báo hỏng thiết bị, xác nhận đã nhận hàng và hoàn trả vật tư thừa.
