...
export const AUDIT_ACTION_INFO: Record<string, { label: string; tone: StatusBadgeVariant; entityLabel?: string }> = {
  ...
  "requisition.order": { label: "Đã đặt hàng NCC", tone: "violet", entityLabel: "Phiếu yêu cầu" },
  "requisition.upload_invoice": { label: "Gửi hóa đơn nhận hàng", tone: "info", entityLabel: "Phiếu yêu cầu" },
  "requisition.direct_complete": { label: "Duyệt hoàn tất qua hóa đơn", tone: "success", entityLabel: "Phiếu yêu cầu" },
