...
def create_presentation(output_path):
    ...
    # Color Palette (Agritech & Modern Industrial Theme)
    C_PRIMARY = RGBColor(15, 76, 129)       # Deep Classic Navy
    ...
    def add_header(slide, title_text, category="MTP FARM ERP • HỆ THỐNG QUẢN TRỊ TOÀN DIỆN"):
    ...
    p3 = tf.add_paragraph()
    p3.text = "Đơn vị áp dụng: Trang Trại Gà Đẻ Trứng Lê Văn Dương (Dầu Tiếng, Bình Dương)
Số hóa Vật tư • Quản lý Cấp phát • Trạm Dầu Xe Cơ Giới • Chống Thất Thoát • Báo Cáo Chi Phí Chuồng Trại"
...
if __name__ == '__main__':
    out = sys.argv[1] if len(sys.argv) > 1 else "/root/Code-Base/SSS/MTP_Farm_ERP_Presentation.pptx"
