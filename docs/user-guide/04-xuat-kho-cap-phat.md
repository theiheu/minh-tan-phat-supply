...
## 2. QUY TRÌNH LẬP PHIẾU XUẤT (Quản kho / Kế toán)
1. Truy cập menu **Xuất kho** (`/issues`) ➜ Bấm **"Tạo phiếu xuất"** (`/issues/new`).
2. Chọn **Loại xuất kho:** *Nội bộ* hoặc *Bán hàng*.
3. Chọn **Khu vực nhận / Trại đích:** (Ví dụ: *Khu A - Trại A2*).
4. Chọn **Vị trí kho xuất:** (Ví dụ: *Kho Tổng*).
5. Thêm danh sách vật tư cần xuất và số lượng.
6. Nhập **Lý do xuất kho / Ghi chú** (Ví dụ: *Cấp bóng đèn sưởi lứa gà con tuần 1*).
